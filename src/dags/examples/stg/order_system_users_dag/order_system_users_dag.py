...
from examples.stg.order_system_users_dag.users_loader import UserLoader
...
@dag(
    ...
    tags=['sprint5', 'example', 'stg', 'origin', 'users'],  # Теги, используются для фильтрации в интерфейсе Airflow.
