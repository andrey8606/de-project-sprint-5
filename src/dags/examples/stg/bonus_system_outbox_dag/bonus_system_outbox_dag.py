...
@dag(
    ...
    tags=['sprint5', 'stg', 'origin', 'outbox'],  # Теги, используются для фильтрации в интерфейсе Airflow.
...
stg_bonus_system_users_dag = sprint5_example_stg_bonus_system_outbox_dag()
